...
public class DamageCalculatorTest {
    ...
    public void itCanCalculateDamageWithNoModifiers_Armor() {
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 0.0, false, fakeDamage, 0.0, 0);
    ...
    public void itCanCalculateDamageWithAHeadshot_Armor() {
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 2.0, false, fakeDamage, 0.0, 0);
    ...
    public void itCanCalculateDamageWithAPositiveBonusAgainstHealthClassWithAHeadshot_Armor() {
        fakeHealth.setHealthClass(HealthClass.INFESTED_FLESH);
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 3.0, false, fakeDamage, 0.0, 0);

        assertEquals(113, actualDamage, 0.001);
    }

    @Test
    public void itCanCalculateDamageWithAPositiveBonusAgainstHealthClassWithAHeadshot_OnCorpus_Armor() {
        fakeHealth.setHealthClass(HealthClass.INFESTED_FLESH);
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 3.0, true, fakeDamage, 0.0, 0);
    ...
    public void itCanCalculateDamageWithAPositiveBonusAgainstHealthClassWithACriticalHeadshot_Armor() {
        fakeHealth.setHealthClass(HealthClass.INFESTED_FLESH);
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 3.0, false, fakeDamage, 3.0, 1);
    ...
    @Test
    public void itCanCalculateDamageWithANegativeBonusAgainstHealthClassWithAHeadshot_OnCorpus_Armor() {
        fakeDamage.setType(DamageType.VOID);
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 3.0, true, fakeDamage, 0.0, 0);
    ...
    @Test
    public void itCanCalculateDamageWithAHeadshot_OnCorpus_Armor() {
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 2.0, true, fakeDamage, 0.0, 0);
    ...
    public void itCanCalculateDamageWithACritical_Armor() {
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 0.0, false, fakeDamage, 2.0, 1);
    ...
    public void itCanCalculateDamageWithALevel2Critical_Armor() {
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 0.0, false, fakeDamage, 2.0, 2);
    ...
    public void itCanCalculateDamageWithALevel5Critical_Armor() {
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 0.0, false, fakeDamage, 2.0, 5);
    ...
    public void itCanCalculateDamageWithACriticalHeadshot_Armor() {
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 2.0, false, fakeDamage, 2.0, 1);
    ...
    public void itCanCalculateDamageWithALevel2CriticalHeadshot_Armor() {
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 2.0, false, fakeDamage, 2.0, 2);

        assertEquals(300.0, actualDamage, 0.001);
    }

    @Test
    public void itCanCalculateDamageWithACriticalHeadshot_OnCorpus_Armor() {
        double actualDamage = subject.calculateDamage(fakeHealth, null, fakeArmor, 2.0, true, fakeDamage, 2.0, 1);
